...
creations[0].style.backgroundImage=`url(../images/desktop/image-curiosity.jpg)`;
creations[1].style.backgroundImage=`url(../images/desktop/image-pocket-borealis.jpg)`;
creations[2].style.backgroundImage=`url(../images/desktop/image-soccer-team.jpg)`;
creations[3].style.backgroundImage=`url(../images/desktop/image-deep-earth.jpg)`;
